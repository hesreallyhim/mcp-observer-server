...
class SubscriptionManager:
    ...
    async def add_change(
        self, subscription_id: str, path: str, event: str
    ) -> Optional[FileChange]:
    ...
    async def add_resource_subscriber(
        self, subscription_id: str, client_id: str
    ) -> bool:
    ...
    async def remove_resource_subscriber(
        self, subscription_id: str, client_id: str
    ) -> bool:
